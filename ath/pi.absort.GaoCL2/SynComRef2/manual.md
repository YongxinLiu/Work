...
# 1. 处理序列 Processing sequences
	...
	# 设置工作目录
	wd=ath/pi.absort.GaoCL2/SynComRef2
...
## 1.10. 生成OTU表
	...
	make otutab_create
    # 记录比对率：1501574 / 11927828 mapped to OTUs (12.6%) 
    # 从头ASV，3512569 / 11927828 mapped to OTUs (29.4%)
    # 按uniques.fa中最高丰度在线blast，占总数据量一多半，为叶绿体
    # 120个样本 > 5000，仅剩24个有序列
    # 1000还能接受
    # 对OTU表生成的样本量可视化，与拆库的比较
    make otutab_sample_count
