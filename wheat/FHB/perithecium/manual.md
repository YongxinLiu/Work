...
# 1. 处理序列 Processing sequences
    ...
    # 手动整理数据
    cd seq
    rename 's/\w+\-//' *.gz # 删除所有开头编号
    rename 's/_R/_/' *.gz # 删除R
    rename 's/AN-4/AN/' *.gz # 删除-
    rename 's/-//g' *.fq.gz
    gunzip *.gz
    # 放在seq/sample目录下，从1.3开始继续
...
## 1.4. 切除引物与标签
	...
	# 切除左端标签和引物，右端 引物
	# Cut barcode 无 + V3 24bp in left， and V4 21bp in right
