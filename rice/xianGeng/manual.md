...
## 1.3. 准备原始数据
    ...
    # 原始数据合并
    cat ~/rice/miniCore/temp/seqs_usearch.fa ~/rice/miniCore/temp/seqs_usearch.fa ~/rice/zjj.nitrogen/180116/temp/seqs_usearch.fa | cut -f 1 -d ';' | sed 's/_/./g' > temp/filtered.fa
